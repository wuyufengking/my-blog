...
date: 2025-11-29
tags: [技术, 随笔, 深度思考]
excerpt: AI 不会取代程序员，但会淘汰那些只会“翻译需求”的人。在这个时代，我们不再需要精确记忆每一个 API，而是需要精确定义每一个“结构”。
---
...
### 📊 投票：现在的你，代码“含 AI 量”是多少？

在最近的一个项目中，你认为由 AI 生成（包括 Copilot 补全、ChatGPT 生成）的代码占比大概是多少？

*   **[ ] < 10%（硬核派）**：我更相信自己的肌肉记忆，AI 仅作为简单的拼写提示。
*   **[ ] 20% - 40%（辅助派）**：我写核心逻辑，AI 帮我写写正则、类型定义和重复性劳动。
*   **[ ] 40% - 70%（协作派）**：正如文中所说，我定义接口和结构，AI 负责填充具体实现。
*   **[ ] > 70%（指挥官）**：我基本不写代码了，我主要负责写 Prompt 和 Code Review。

*(请在评论区回复你的选项，或者聊聊你的“人机协作”心得)*